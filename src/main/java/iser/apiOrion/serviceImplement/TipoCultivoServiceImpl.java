...
public class TipoCultivoServiceImpl implements TipoCultivoService {
    ...
    public ResponseEntity<?> buscarTodos() {
        try {
            ...
            return ResponseEntity.badRequest().body(buildMessage("Error al buscar los tipos de cultivo"));
        }
    }
    ...
    public ResponseEntity<?> buscarPorId(String id) {
        try {
            ...
            return ResponseEntity.badRequest().body(buildMessage("Error al buscar el tipo de cultivo"));
        }
    }
    ...
    public ResponseEntity<?> guardar(TipoCultivo tipoCultivo) {
        try {
            ...
            return ResponseEntity.badRequest().body(buildMessage("Error al guardar el tipo de cultivo"));
        }
    }
    ...
    public ResponseEntity<?> actualizar(TipoCultivo tipoCultivo) {
        try {
            ...
            if (tipoCultivoOptional.isEmpty()) {
                return ResponseEntity.badRequest().body(buildMessage("El tipo de cultivo no existe"));
            }
            return ResponseEntity.ok(tipoCultivoRepository.save(tipoCultivo));
        } catch (Exception e) {
            return ResponseEntity.badRequest().body(buildMessage("Error al actualizar el tipo de cultivo"));
        }
    }
    ...
    public ResponseEntity<?> eliminar(String id) {
        try {
            ...
            return ResponseEntity.badRequest().body(buildMessage("Error al eliminar el tipo de cultivo"));
        }
    }
}
